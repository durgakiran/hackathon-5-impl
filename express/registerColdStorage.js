...
async function registerColdStorage(id, info) {
    try {
        ...
        await contract.submitTransaction('registerColdStorage', id, JSON.stringify(info));
...
module.exports = registerColdStorage;
