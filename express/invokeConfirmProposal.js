...
async function invokeConfirmProposal(id, resId, reqId, info) {
    try {
        ...
        await contract.submitTransaction('ConfirmProposal', id, resId, reqId, JSON.stringify(info));
...
module.exports = invokeConfirmProposal;
