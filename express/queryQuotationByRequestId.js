...
async function queryQuotationRequestId(id) {
    try {
        ...
        const result = await contract.evaluateTransaction('GetQuotationsByReqId', id);
...
module.exports = queryQuotationRequestId;
