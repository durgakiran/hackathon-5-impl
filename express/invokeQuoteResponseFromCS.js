...
async function invokeQuoteResponseFromCS(id, reqId, info) {
    try {
        ...
        await contract.submitTransaction('QuoteResponseFromCS', id, reqId, JSON.stringify(info));
...
module.exports = invokeQuoteResponseFromCS;
