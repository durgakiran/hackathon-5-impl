...
async function invokeRequestForQuotation(userid, id, info) {
    try {
        ...
        await contract.submitTransaction('RequestForQuotation', userid, id, JSON.stringify(info));
...
module.exports = invokeRequestForQuotation;
