...
async function invokeRegisterUser(id, info) {
    try {
        ...
        const result = await contract.submitTransaction('RegisterUser', id, JSON.stringify(info));
...
module.exports = invokeRegisterUser;
